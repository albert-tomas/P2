...
"   -1 FLOAT, --alfa1=FLOAT     Margen sobre P0 para determinar el umbral 1 de un V/S [default: 1.3]\n"
"   -2 FLOAT, --alfa2=FLOAT     Margen sobre P0 para determinar el umbral 2 de un V/S [default: 7.71]\n"
"   -n INT, --N_tramas_ini=INT  Número de frames per calcular potencia inicial [default: 9]\n"
